...
class FastBlockView
{
	...
	public function field($field_string)
	{
		...
		if (
			isset($orig_fields[$field_string]['input']) &&
	...
	/**
	 * get values from all fields. returns all attributes
	 */
	public function all_field_values()
	{
		return fast_blocks_instance()->get_current_attributes();
	}
}
